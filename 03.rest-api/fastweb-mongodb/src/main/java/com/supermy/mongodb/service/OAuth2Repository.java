...
import com.supermy.mongodb.domain.OAuth2;
 ...
 *
 */
public interface OAuth2Repository extends MongoRepository<OAuth2, ObjectId> {

	@Query("{ 'name':{'$regex':?0,'$options':'i'}, sales': {'$gte':?1,'$lte':?2}}")
	void addAuthCode(String authorizationCode);
